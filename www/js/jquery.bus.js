...
(function($){
	var BUSAPI = function(element, options) {
		...
		var settings = $.extend({
	           ...
	           apiKey : "MDAzNDk2MDIzMDEyOTc4NzIxNDMyMjZkMA001"
			}, options || {});
		...
		this.loadLocalStreams = function(options) {
			...
			var apiUrl = "http://api.npr.org/v2/locations/" + settings.lat + "," + settings.lon + "/streams?apiKey=" + settings.apiKey;
		...
		this.loadLocalEpisodes = function(options) {
			...
			var apiUrl = "http://api.npr.org/v2/locations/" + settings.lat + "," + settings.lon + "/episodes?apiKey=" + settings.apiKey;
